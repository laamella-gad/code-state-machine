...
// */
//abstract class JavaStyleDslStateMachineBuilder<T, E, P : Comparable<P>>(private val defaultPriority: P) :
...
//
//    companion object {
//        private val log: Logger = LoggerFactory.getLogger(JavaStyleDslStateMachineBuilder::class.java)
//
