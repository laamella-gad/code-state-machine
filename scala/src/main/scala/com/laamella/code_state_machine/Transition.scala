 ...
 */
class Transition[T, E, P <: Ordered[P]](val sourceState: T, val destinationState: T, val conditions: Conditions[E], val priority: P, val actions: Seq[Action]) extends Ordered[Transition[T, E, P]] {
